...
#define LCD_Char_1_PORT_MASK                (LCD_Char_1_LCDPort__MASK)
    ...
    */
    ...
    #define LCD_Char_1_DM_DATA_MASK             (0xFFFul << (LCD_Char_1_PORT_SHIFT * 3u))
...
/* Pin Masks */
#define LCD_Char_1_RS                       ((uint8) (((uint8) 0x20u) << LCD_Char_1_LCDPort__SHIFT))
#define LCD_Char_1_RW                       ((uint8) (((uint8) 0x40u) << LCD_Char_1_LCDPort__SHIFT))
#define LCD_Char_1_E                        ((uint8) (((uint8) 0x10u) << LCD_Char_1_LCDPort__SHIFT))
#define LCD_Char_1_READY_BIT                ((uint8) (((uint8) 0x08u) << LCD_Char_1_LCDPort__SHIFT))
#define LCD_Char_1_DATA_MASK                ((uint8) (((uint8) 0x0Fu) << LCD_Char_1_LCDPort__SHIFT))
