// ======================================================================
// BitBanging.v generated from TopDesign.cysch
// 05/12/2013 at 16:54
...
// CharLCD_v1_80(ConversionRoutines=true, CUSTOM0=0,E,8,8,8,E,0, CUSTOM1=0,A,A,4,4,4,0, CUSTOM2=0,E,A,E,8,8,0, CUSTOM3=0,E,A,C,A,A,0, CUSTOM4=0,E,8,C,8,E,0, CUSTOM5=0,E,8,E,2,E,0, CUSTOM6=0,E,8,E,2,E,0, CUSTOM7=0,4,4,4,0,4,0, CustomCharacterSet=0, CY_COMPONENT_NAME=CharLCD_v1_80, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=LCD_Char_1, CY_INSTANCE_SHORT_NAME=LCD_Char_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=80, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=LCD_Char_1, )
module CharLCD_v1_80_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e684fdfd-04bb-4af1-8dac-1527ce86dd26/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module USBFS_v2_50_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("9ba19935-03c0-4ead-b0e1-2701bf4bf438/8b77a6c4-10a0-4390-971c-672353e2a49c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9ba19935-03c0-4ead-b0e1-2701bf4bf438/618a72fc-5ddd-4df5-958f-a3d55102db42"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__DataLine_net;
	wire [0:0] tmpFB_0__DataLine_net;
	wire [0:0] tmpINTERRUPT_0__DataLine_net;
	electrical [0:0] tmpSIOVREF__DataLine_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5c1decb5-69e3-4a8d-bb0c-281221d15217"),
		  ...
		  .width(1))
		DataLine
		 (.oe(tmpOE__DataLine_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DataLine_net[0:0]}),
		  .io({Net_7}),
		  .siovref(tmpSIOVREF__DataLine_net),
		  .interrupt({tmpINTERRUPT_0__DataLine_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DataLine_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ClockLine_net;
	wire [0:0] tmpFB_0__ClockLine_net;
	wire [0:0] tmpINTERRUPT_0__ClockLine_net;
	electrical [0:0] tmpSIOVREF__ClockLine_net;

	cy_psoc3_pins_v1_10
		#(.id("ce4ba913-c0f0-4427-822c-ab1efe5241ac"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .width(1))
		ClockLine
		 (.oe(tmpOE__ClockLine_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ClockLine_net[0:0]}),
		  .io({Net_6}),
		  .siovref(tmpSIOVREF__ClockLine_net),
		  .interrupt({tmpINTERRUPT_0__ClockLine_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ClockLine_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__FREX_net;
	wire [0:0] tmpFB_0__FREX_net;
	wire [0:0] tmpIO_0__FREX_net;
	wire [0:0] tmpINTERRUPT_0__FREX_net;
	electrical [0:0] tmpSIOVREF__FREX_net;
	...
	cy_psoc3_pins_v1_10
		...
		FREX
		 (.oe(tmpOE__FREX_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__FREX_net[0:0]}),
		  .io({tmpIO_0__FREX_net[0:0]}),
		  .siovref(tmpSIOVREF__FREX_net),
		  .interrupt({tmpINTERRUPT_0__FREX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__FREX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__EXPST_net;
	wire [0:0] tmpFB_0__EXPST_net;
	wire [0:0] tmpIO_0__EXPST_net;
	wire [0:0] tmpINTERRUPT_0__EXPST_net;
	electrical [0:0] tmpSIOVREF__EXPST_net;

	cy_psoc3_pins_v1_10
		#(.id("b0c12a4a-4179-4bd8-8503-f115dd6e3523"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		EXPST
		 (.oe(tmpOE__EXPST_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__EXPST_net[0:0]}),
		  .io({tmpIO_0__EXPST_net[0:0]}),
		  .siovref(tmpSIOVREF__EXPST_net),
		  .interrupt({tmpINTERRUPT_0__EXPST_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EXPST_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("915a43f9-81e1-4dc3-b819-b79ec86258a5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PWND_net;
	wire [0:0] tmpFB_0__PWND_net;
	wire [0:0] tmpIO_0__PWND_net;
	wire [0:0] tmpINTERRUPT_0__PWND_net;
	electrical [0:0] tmpSIOVREF__PWND_net;

	cy_psoc3_pins_v1_10
		#(.id("46ee7c50-d4e5-426c-84a0-4adddc25ebbb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PWND
		 (.oe(tmpOE__PWND_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PWND_net[0:0]}),
		  .io({tmpIO_0__PWND_net[0:0]}),
		  .siovref(tmpSIOVREF__PWND_net),
		  .interrupt({tmpINTERRUPT_0__PWND_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWND_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RST_B_net;
	wire [0:0] tmpFB_0__RST_B_net;
	wire [0:0] tmpIO_0__RST_B_net;
	wire [0:0] tmpINTERRUPT_0__RST_B_net;
	electrical [0:0] tmpSIOVREF__RST_B_net;

	cy_psoc3_pins_v1_10
		#(.id("f94c5369-00a6-4beb-9561-5cd4c7c9cf0b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		RST_B
		 (.oe(tmpOE__RST_B_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RST_B_net[0:0]}),
		  .io({tmpIO_0__RST_B_net[0:0]}),
		  .siovref(tmpSIOVREF__RST_B_net),
		  .interrupt({tmpINTERRUPT_0__RST_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RST_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CharLCD_v1_80_0 LCD_Char_1 ();

	wire [7:0] tmpOE__DataBus_net;
	wire [7:0] tmpIO_7__DataBus_net;
	wire [0:0] tmpINTERRUPT_0__DataBus_net;
	electrical [0:0] tmpSIOVREF__DataBus_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4c15b41e-e284-4978-99e7-5aaee19bd0ce"),
		  ...
		  .width(8))
		DataBus
		 (.oe(tmpOE__DataBus_net),
		  .y({8'b0}),
		  .fb({Net_42, Net_41, Net_40, Net_39, Net_38, Net_37, Net_36, Net_35}),
		  .io({tmpIO_7__DataBus_net[7:0]}),
		  .siovref(tmpSIOVREF__DataBus_net),
		  .interrupt({tmpINTERRUPT_0__DataBus_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DataBus_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
	...
	cy_psoc3_pins_v1_10
		#(.id("9eb069ef-042a-41f3-920b-bc8aa759a962"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7c16590b-1b31-44fb-87f1-83717496ab57"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0ab393f7-1a26-492d-a00d-612b42b5b357"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("62ab1814-8e4c-4b43-bfad-9ba20f661289"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1abaa526-7d2c-489f-a8f8-a9c442b1c588"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("dacd5ca1-ba39-4569-9969-2136898d989f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b3d80e48-0474-4b7f-8cae-ccc51be5772a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("aba8e3f8-9a31-42a8-891e-cb685a53f089"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__pin_HREF_FALL_net;
	wire [0:0] tmpIO_0__pin_HREF_FALL_net;
	wire [0:0] tmpINTERRUPT_0__pin_HREF_FALL_net;
	electrical [0:0] tmpSIOVREF__pin_HREF_FALL_net;

	cy_psoc3_pins_v1_10
		#(.id("0efa35b3-a2e5-46d2-bef8-3ce299f4ed3f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		pin_HREF_FALL
		 (.oe(tmpOE__pin_HREF_FALL_net),
		  .y({1'b0}),
		  .fb({Net_235}),
		  .io({tmpIO_0__pin_HREF_FALL_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_HREF_FALL_net),
		  .interrupt({tmpINTERRUPT_0__pin_HREF_FALL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_HREF_FALL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
