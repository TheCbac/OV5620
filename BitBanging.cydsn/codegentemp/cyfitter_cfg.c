...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x4800001Cu)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000030u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CLKDIST_DCFG0_CFG0 + 0x2), 0x58u);
